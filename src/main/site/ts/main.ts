...
let sunElement = document.getElementById('sun') as HTMLSelectElement;
let moonElement = document.getElementById('moon') as HTMLSelectElement;
let risingElement = document.getElementById('rising') as HTMLSelectElement;
